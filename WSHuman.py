...
from WSHumanCirculatory import WSHumanCirculatory
from WSHumanRespiratory import WSHumanRespiratory

# A model of a human.
class WSHuman(WSNode):
  ...
  def __init__(self, Crabs, TID, Type = "Human"):
    WSNode.__init__(self, Crabs, TID, Type)
    ...
    self.Circulatory = WSHumanCirculatory(self, )
    # The human's Respiratory system.
    self.Respiratory = WSHumanRespiratory(Crabs, self.Meta["Sex"])
